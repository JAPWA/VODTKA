...
local Text = [[
اهلا بك في سورس الفودكا الجمدان
...
if text == 'فرنسا' or text == 'المبرمج فرنسا' or text == 'مبرمج السورس' or text == 'صاحب السورس' then
local Text = [[
...
if text == 'قناص' or text == 'القناص' or text == 'المالك قناص' or text == 'مالك السورس' then
local Text = [[
...
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐓𝐊𝐀', url="t.me//chair"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖢄' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/senddocument?chat_id=' .. msg.chat_id_ .. '&document=https://t.me/CH_JABWA /'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{
{text = ' 𖢄 لقائمه الرائسيه  𖢄', callback_data="/change-id"},
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐓𝐊𝐀', url="t.me/A_F_fwdka1"},
},
