...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/JAPWA/VODTKA/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1124610301,2038767028,2002118176,2094348305,1779781675}   
...
os.execute('wget https://raw.githubusercontent.com/JAPWA/VODTKA/main/DRAGON.lua')
...
𓆩[𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊??𝙍𝘾𝙀 𝙑𝙄𝙆𝙄𝙉𝙂](http://t.me/V_I_K_I_N_G_1)𓆪
𖣘━━━⊶♢𝙑𝙄𝙆𝙄𝙉𝙂♢⊷━━━𖣘
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙏𝙄𝙈𝙊',url="t.me/ttimo_8lby"},{text = '𝘼𝙎𝘼𝙇𝙄𝙔𝘼',url="t.me/AsaliyaEgypt"}},
{{text = '𝙊𝙈𝘼𝙍',url="t.me/teemElmelok"},{text = '𝘼𝘽𝙊 𝙀𝙇𝙈𝘼𝙂𝘿 ',url="t.me/ABO_ELMAGD2"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𝘼𝙎𝘼𝙇𝙄𝙔𝘼❩', url="t.me/AsaliyaEgypt"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'تيمو' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج تيمو لو حابب تتواصل معاه اتبع الزر ال في الاسفل ⇩⇧
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local Text = [[
[ 𖣘 اهلا بك في سورس فايكينج الجمدان 𖣘](http://t.me/V_I_K_I_N_G_1)
[ 𖣘 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖣘](http://t.me/V_I_K_I_N_G_1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙏𝙄𝙈𝙊',url="t.me/ttimo_8lby"},{text = '𝘼𝙎𝘼𝙇𝙄𝙔𝘼',url="t.me/AsaliyaEgypt"}},
...
if text and text:match("^عسليه$") or text and text:match("^Banda$") or text and text:match("^banda$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1124610301,"🌏. هناك شخص يريدك يا سيدي عسليه \n🌏الشخص  {"..Name.."}\n🌏اسم الجروب {"..NameChat.."}\n🌏ايدي الجروب { `"..msg.chat_id_.."` }\n🌏رابط الجروب \n [ "..LinkGroup.." ]\n    🌏رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end

if text and text:match("^@AsaliyaEgypt$") or text and text:match("^Banda$") or text and text:match("^banda$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
if text == 'المكتئب' or text == 'المكتئب الحزين' or text == 'مطور السورس'  then
local Text = [[
المكتئب مطور سورس فايكينج للتواصل معه اتبع الزر الاسفل ⬇️💕. 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝙴𝙻 𝙼𝚄𝙺𝚃𝙰𝚈𝙸𝙱₎ •𖣘❩',url="t.me/Asaliya_Egypt_2"}},
{{text = '˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》˼',url="t.me/V_I_K_I_N_G_1"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [𝚠𝚎𝚕𝚌𝚘𝚖𝚎 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶](http://t.me/V_I_K_I_N_G_1)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》˼ ', url="t.me/V_I_K_I_N_G_1"}}, 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/JAPWA/VODTKA/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/JAPWA/VODTKA/main/File_Bot/"..file)
if res == 200 then
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEVASALIYA/84&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEVASALIYA/86&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[˹《𝚂𝙾𝚄𝚁𝙲?? 𝚅𝙸𝙺𝙸𝙽𝙶》˼ ](t.me/V_I_K_I_N_G_1)❳ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
